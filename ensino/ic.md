...
* WILSON PEREIRA BARBOSA SILVA. Complexidade e extensão dos métodos de descenso coordenado por blocos. Início: 2024. Programa de Iniciação Científica Voluntária – ICV/UFPI (IC)
* KAIAN DA SILVA GOMES. Complexidade e extensão dos métodos de descenso coordenado por blocos. Programa de Iniciação Científica Voluntária – ICV/UFPI (IC)
* ANTONIO INACIO DA SILVA NETO. Complexidade e extensão dos métodos de decida coordenada. Programa de Iniciação Científica Voluntária – ICV/UFPI (IC)
* LIVIA FERREIRA DA SILVA SANTOS. Um estudo da complexidade dos métodos de decida coordenada. Programa de Iniciação Científica Voluntária – ICV/UFPI (IC)
* Cauan de Oliveira da Silva. Estudo dos métodos de minimização por blocos e aplicações.Programa de Iniciação Científica Voluntária – ICV/UFPI (IC)
